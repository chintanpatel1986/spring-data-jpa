...
<div class="container mt-5 border border-1">
    <div class="container">
        ...
        <form:form action="/spring_data_jpa/employees/insertOrUpdateEmployee" method="post" cssClass="row g-3" modelAttribute="employee">
            ...
            <div class="col-6">
                <div class="col-6">
                    <form:label path="programmingSkill" cssClass="form-label fw-bold">Programming Skill</form:label>
                </div>
                <div class="form-check form-check-inline">
                ...
                <div class="form-check form-check-inline">
                    <form:checkbox path="programmingSkill" cssClass="form-check-input" value="PHP"/>
                ...
                <form:errors path="programmingSkill" cssClass="text-danger"/>
            </div>
            <div class="col-4">
